...
本模块深入学习 Java 集合框架体系，包括 List、Set、Map 三大核心接口及其实现类，以及 Collections 工具类和泛型进阶知识，是数据处理的核心技能。
...
- 理解集合框架的整体体系结构
- 掌握 ArrayList、LinkedList 的原理与使用场景
- 理解 HashSet、TreeSet 的底层数据结构
- 掌握 HashMap 的工作原理与源码分析
- 熟练使用 Collections 工具类进行集合操作
- 理解泛型进阶知识与集合性能对比
